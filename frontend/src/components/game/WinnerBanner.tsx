...
export default function WinnerBanner({ winnerUsername, isYou, onGoToResults }: WinnerBannerProps) {
  return (
    <motion.div
      className="fixed inset-0 z-50 flex items-center justify-center bg-inverse-surface/50 p-space-md"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    >
      <motion.div
        className="rounded-2xl bg-surface-container-lowest px-space-xl py-space-xl text-center shadow-2xl"
