...
export default function HandDrawnBorder({ children, className = '' }) {
    ...
    return (<div className={`relative ${className}`}>
      <svg className="pointer-events-none absolute inset-0 h-full w-full" aria-hidden="true">
        <rect x="2" y="2" width="calc(100% - 4px)" height="calc(100% - 4px)" rx="8" fill="none" stroke="#5b403d" strokeWidth="1.5" strokeDasharray="1 0" style={{ filter: 'url(#wobble-edge)' }}/>
