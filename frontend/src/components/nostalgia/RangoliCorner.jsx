...
export default function RangoliCorner({ corner = 'top-left', size = 72 }) {
    return (<svg className={`pointer-events-none absolute ${ROTATIONS[corner]} opacity-40`} width={size} height={size} viewBox="0 0 72 72" aria-hidden="true">
