  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative w-full pt-16 pb-16 lg:pb-24 px-space-md lg:px-margin overflow-hidden bg-gradient-to-b from-surface-container-high/30 via-surface-container/15 to-transparent dark:from-surface-container-high/15 dark:via-surface-container/5 dark:to-transparent transition-colors duration-300">
        <div
          className="absolute inset-0 opacity-40 dark:opacity-15 text-secondary dark:text-outline-variant pointer-events-none"
          style={{ backgroundImage: 'radial-gradient(currentColor 0.75px, transparent 0.75px)', backgroundSize: '24px 24px' }}
        />
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-xl lg:gap-space-lg items-center">
          <div className="lg:col-span-6 flex flex-col items-start text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-space-sm w-full sm:w-auto mb-space-lg">
              <Link
                to="/signup"
                className="group relative px-space-lg py-space-md rounded-lg bg-primary text-on-primary font-label-lg text-label-lg font-bold shadow-md hover:shadow-xl hover:bg-primary-container active:translate-y-0.5 transition-all flex items-center justify-center gap-space-xs"
              >
            ...
            <div className="w-full sm:max-w-md p-space-sm rounded-xl bg-surface-container-low shadow-sm flex items-center gap-space-sm">
              ...
              <input
                ...
                className="flex-1 bg-surface-container-lowest px-space-sm py-1.5 rounded font-label-md text-label-md text-on-surface uppercase tracking-widest outline-none text-center placeholder:text-outline-variant"
              />
              <Link
                to="/login"
                className="px-space-md py-1.5 rounded-lg bg-surface-container-highest hover:bg-secondary-fixed text-on-secondary-container font-label-sm text-label-sm uppercase font-bold transition-colors"
              >
                Enter
              </Link>
            </div>
            ...
            <div className="relative w-full max-w-[500px] bg-surface-container-lowest dark:bg-surface-container-low/90 dark:border dark:border-outline-variant/30 rounded-full p-space-lg shadow-2xl flex flex-col items-center justify-between aspect-square">
              ...
              <div className="w-full flex items-center justify-between px-space-xs">
                ...
                <div className="relative flex flex-col items-center justify-center">
                  <div
                    className="w-32 h-32 lg:w-36 lg:h-36 rounded-full hover:scale-105 active:scale-95 transition-all duration-300 flex flex-col items-center justify-center text-center p-space-sm relative z-20 group cursor-pointer overflow-hidden"
                    style={{
                  ...
                  <div
                    className="absolute -top-10 -right-8 w-11 h-11 rounded-full bg-surface-container-highest shadow-sm flex items-center justify-center"
                    title="Cutting Chai"
                  >
              ...
              <div className="w-full flex flex-col items-center -mb-4">
                <div className="flex items-center -space-x-5 hover:space-x-1 transition-all duration-300">
                  {['Raja', 'Raja', 'Raja', 'Wazir'].map((name, i) => (
                    <div
                      key={i}
                      className="w-16 h-24 sm:w-20 sm:h-32 rounded bg-surface-container-lowest shadow-md p-2 flex flex-col justify-between cursor-pointer hover:-translate-y-4 hover:rotate-0 transition-transform"
      ...
      <section className="px-space-md lg:px-margin py-16">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-space-lg">
          {STEPS.map((step) => (
            <div key={step.n} className="rounded-xl bg-surface-container-low p-space-lg shadow-sm">
              <div
                className={`w-8 h-8 rounded-full ${step.color} text-on-primary flex items-center justify-center font-bold text-label-md mb-space-md`}
              >
                {step.n}
              </div>
            ...
            <div className="lg:col-span-2 rounded-xl bg-surface-container-lowest p-space-lg shadow-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-space-sm">
                {[
                  ...
                  <div key={set.name} className="rounded-lg bg-surface-container-high p-space-sm text-center">
      ...
      <section className="px-space-md lg:px-margin py-20 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-space-sm">
            <Link
              to="/signup"
              className="px-space-lg py-space-md rounded-lg bg-primary text-on-primary font-label-lg text-label-lg font-bold shadow-md hover:shadow-xl flex items-center justify-center gap-space-xs w-full sm:w-auto"
            >
            ...
            <Link
              to="/rules"
              className="px-space-lg py-space-md rounded-lg bg-surface-container-lowest text-on-surface font-label-lg text-label-lg font-bold shadow-sm hover:shadow-md flex items-center justify-center gap-space-xs w-full sm:w-auto border border-outline-variant"
            >
