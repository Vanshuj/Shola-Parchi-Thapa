...
export default function RulesPage() {
    return (<div className="max-w-5xl mx-auto px-space-md lg:px-margin py-space-xl">
      ...
      <div className="space-y-space-lg mb-space-xl">
        {SECTIONS.map((section) => (<section key={section.n} className="rounded-xl bg-surface-container-low p-space-lg">
      ...
      <div className="mb-space-xl">
        ...
        <div className="space-y-space-xs">
          {FAQS.map((faq) => (<details key={faq.q} className="rounded-lg bg-surface-container-low p-space-md group">
      ...
      <div className="rounded-xl bg-primary text-on-primary p-space-lg flex flex-col sm:flex-row items-center justify-between gap-space-md">
        ...
        <div className="flex gap-space-sm shrink-0">
          <Link to="/lobby" className="px-space-lg py-space-sm rounded-lg bg-secondary-container text-on-secondary-container font-label-lg text-label-lg font-bold shadow-sm hover:shadow-md whitespace-nowrap">
            Enter Game Lobby
          </Link>
          <Link to="/customize" className="px-space-lg py-space-sm rounded-lg bg-surface-container-lowest text-on-surface font-label-lg text-label-lg font-bold shadow-sm hover:shadow-md whitespace-nowrap">
            Personalize Chits
          </Link>
        </div>
      </div>
