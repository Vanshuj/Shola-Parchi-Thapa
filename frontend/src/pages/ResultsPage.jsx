...
export default function ResultsPage() {
    ...
    if (!history)
        return <Loader />;
    return (<div className="max-w-2xl mx-auto px-space-md lg:px-margin py-space-xl">
      ...
      <ol className="mt-space-lg space-y-space-xs">
        {history.map((move) => (<li key={move.turnNumber} className="rounded-lg bg-surface-container-low px-space-md py-space-sm font-body-md text-body-md text-on-surface-variant flex items-center gap-space-sm">
