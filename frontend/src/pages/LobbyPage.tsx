...
export default function LobbyPage() {
  ...
  const { register, handleSubmit, reset: resetJoinForm } = useForm<JoinFormValues>();
  ...
  async function handleJoinRoom(values: JoinFormValues) {
  ...
  if (code) {
    if (loadingRoom && !room) {
      return (
        <div className="max-w-4xl mx-auto px-space-md py-space-xl text-center">
    ...
    if (roomError) {
      return (
        <div className="max-w-xl mx-auto px-space-md py-space-xl text-center">
    ...
    if (room) {
      return (
        <div className="max-w-5xl mx-auto px-space-md lg:px-margin py-space-lg">
          {/* Breadcrumb / Top Bar */}
          ...
          {labels && (
            <div className="mt-space-lg rounded-xl bg-surface-container-low border border-outline-variant p-space-md flex flex-col sm:flex-row items-center justify-between gap-space-sm">
              ...
              <Link
                to="/customize"
                className="px-space-md py-1.5 rounded-lg bg-surface-container-highest hover:bg-surface-container-high text-secondary font-label-sm text-label-sm font-bold transition-colors flex items-center gap-1"
              >
  ...
  return (
    <div className="max-w-6xl mx-auto px-space-md lg:px-margin py-space-xl">
      ...
      {joinError && (
        <div className="mb-space-lg rounded-xl bg-error-container text-on-error-container px-space-md py-space-sm flex items-center justify-between gap-space-sm">
          <div className="flex items-center gap-space-xs">
          ...
          <button
            ...
            className="font-bold text-label-sm underline"
          >
            Dismiss
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-space-lg mb-space-xl">
        ...
        <div className="rounded-2xl bg-surface-container-low border border-outline-variant p-space-lg shadow-sm flex flex-col justify-between hover:border-primary/40 transition-colors">
            ...
            <div className="rounded-xl bg-surface-container-lowest p-space-sm mb-space-md flex items-center justify-between border border-outline-variant">
              ...
              <div className="flex gap-1">
                <button
                  ...
                  className={`px-space-sm py-1 rounded-lg text-label-sm font-bold transition-colors ${
                    isPrivate
          ...
          <Button
            ...
            disabled={creating}
            className="w-full flex items-center justify-center gap-space-xs py-3"
          >
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(handleJoinRoom)} className="space-y-space-md">
              <Input
                ...
                {...register('code')}
                className="text-center font-mono font-bold tracking-widest text-title-md uppercase py-2.5"
              />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-space-lg">
        ...
        <div className="rounded-xl bg-surface-container-lowest border border-outline-variant p-space-md flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-space-xs mb-space-md">
              {labels ? (
                Object.entries(labels).map(([k, val], i) => (
                  <div
                    key={k}
                    className="rounded-lg bg-surface-container-low p-space-xs text-center border border-outline-variant/60"
                  >
                ...
                <div className="col-span-4 text-center py-2 text-on-surface-variant font-body-sm">
                  Loading deck labels…
                </div>
              )}
            </div>
          ...
          <Link
            to="/customize"
            className="inline-flex items-center justify-center gap-1 px-space-md py-2 rounded-lg bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md font-bold transition-colors"
          >
        ...
        <div className="rounded-xl bg-surface-container-lowest border border-outline-variant p-space-md flex flex-col justify-between">
          ...
          <div className="flex gap-space-sm">
            <Link
              to="/rules"
              className="flex-1 inline-flex items-center justify-center gap-1 px-space-md py-2 rounded-lg bg-surface-container hover:bg-surface-container-high text-on-surface font-label-md text-label-md font-bold transition-colors"
            >
